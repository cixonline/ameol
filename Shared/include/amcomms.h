...
BOOL WINAPI Amcomm_Open( LPCOMMDEVICE FAR *, LPSTR, COMMCALLBACK, DWORD, char *, HWND, LPRASDATA, BOOL, BOOL );
BOOL WINAPI Amcomm_OpenCard( HWND, LPCOMMDEVICE FAR *, LPVOID, COMMCALLBACK, DWORD, char *, HWND, BOOL, BOOL );
