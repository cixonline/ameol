...
#ifdef ADOBE
// Support for custom drawing of margins (CL258510). 
#define SCN_CUSTOMDRAWMARGIN 2025
// Fix: #1465915 JP: LOC-NOTTRANS: The content menu items on the document window aren’t translated.
#define SCN_TRANSLATETEXT 2026	
#endif
...
#ifdef ADOBE
// Support for custom drawing of margins (CL258510). 
struct MarginCustomDrawInfo {
	int			margin;
// Support for SciTE (CL286859)	
#ifdef PLATFORM_H
	SurfaceID	surfaceID;
	PRectangle	rect;
#endif
...
struct SCNotification {
	...
	char *translation;					// SCN_TRANSLATETEXT
#endif
...
#ifdef ADOBE
	// Support for custom drawing of margins (CL258510). 
	struct MarginCustomDrawInfo cdm;	// SCN_CUSTOMDRAWMARGIN
#endif
};
