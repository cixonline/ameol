/* ITSYBITS.C - Code that draws small caption windows.
 *
 * Copyright 1993-1996 Microsoft, All Rights Reserved
 *
 * This source code was taken from the MSDN library and used
 * under licence.
 *
 * Originally written by Charlie Kindel (cek/ckindel)
 * Microsoft Premier Product Support
 */
...
BOOL NEAR PASCAL DrawItsyCaption( HDC hDC, HWND hWnd, LPRECT lprc,
    ...
    switch( uiMsg )
    {
        ...
        case WM_NCACTIVATE:
            ...
            if (HASCAPTION( hWnd ))
            {
                ...
                DrawItsyCaption( hDC, hWnd, &rcCap,
...
// DrawItsyCaption( HDC hDC, HWND hWnd, LPRECT lprc,
